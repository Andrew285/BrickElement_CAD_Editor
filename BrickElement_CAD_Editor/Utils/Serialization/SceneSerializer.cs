...
namespace Core.Services.Serialization
{
    ...
    public class SceneSerializationService
    {
        ...
        private BrickElementSurface ConvertDTOToSurface(BrickElementSurfaceDTO dto, IScene scene)
        {
            ...
            {
                TwentyNodeBrickElement be = ConvertDTOToBrickElement(beDTO);
        ...
        private TwentyNodeBrickElement ConvertDTOToBrickElement(TwentyNodeBrickElementDTO dto)
        {
            ...
            {
                BasePlane3D face = ConvertDTOToPlane(faceDTO, vertexMap);
                faces.Add(face);
            }
            ...
            be.IsSelected = dto.IsSelected;
            be.NonSelectedColor = dto.NonSelectedColor.ToColor();
            be.SelectedColor = dto.SelectedColor.ToColor();
        ...
        private BasePoint3D ConvertDTOToPoint(BasePoint3DDTO dto)
        {
            ...
            point.IsSelected = dto.IsSelected;
            point.NonSelectedColor = dto.NonSelectedColor.ToColor();
            point.SelectedColor = dto.SelectedColor.ToColor();
        ...
        private BaseLine3D ConvertDTOToLine(BaseLine3DDTO dto, Dictionary<Guid, BasePoint3D> vertexMap)
        {
            ...
            line.IsSelected = dto.IsSelected;
            line.NonSelectedColor = dto.NonSelectedColor.ToColor();
            line.SelectedColor = dto.SelectedColor.ToColor();
            return line;
        }

        private BasePlane3D ConvertDTOToPlane(BasePlane3DDTO dto, Dictionary<Guid, BasePoint3D> vertexMap)
        {
            ...
            foreach (var triangleDTO in dto.TrianglePlanes)
            {
                TrianglePlane3D triangle = new TrianglePlane3D(
                    vertexMap[triangleDTO.Point1Id],
                ...
                triangle.NonSelectedColor = triangleDTO.NonSelectedColor.ToColor();
            ...
            BasePoint3D centerPoint = dto.CenterPointId.HasValue
                ? vertexMap[dto.CenterPointId.Value]
                : null;
            ...
            plane.IsSelected = dto.IsSelected;
            plane.DrawCustom = dto.DrawCustom;
            plane.Pressure = dto.Pressure;
            plane.IsFixed = dto.IsFixed;
            plane.IsStressed = dto.IsStressed;
            plane.NonSelectedColor = dto.NonSelectedColor.ToColor();
            plane.SelectedColor = dto.SelectedColor.ToColor();
